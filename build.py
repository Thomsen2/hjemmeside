...
def nav_html_bordkort(active: str, prefix: str = "") -> str:
    ...
    return f"""    <nav class="main-nav" id="mainNav">
        <div class="container nav-bar">
            ...
            <div class="nav-links" id="navLinks">
                <a href="{home_href}" class="{cls('home')}">
    ...
    graph.append(
        {
            ...
            "isPartOf": {"@type": "WebSite", "name": "Bordkort.dk", "url": "https://bordkort.dk/"},
        }
    )
    graph.append(
        {
            "@type": "BreadcrumbList",
            "itemListElement": [
                {"@type": "ListItem", "position": 1, "name": "Forside", "item": "https://bordkort.dk/"},
...
ABOUT_BORDKORT = "På Bordkort.dk laver vi personlige bordkort i træ til konfirmation, fødselsdag og andre festlige lejligheder. Bordkortene fremstilles efter bestilling, så de kan tilpasses den enkelte fest og gæsternes navne."
...
def about_section_bordkort() -> str:
    return f"""    <section class="about">
        <div class="container">
            ...
            <p>Se vores udvalg af <a href="/navne/">personlige bordkort med navn</a>. Har du brug for motiver, finder du også <a href="/speciale/">specielle bordkort</a>, og til noget helt særligt laver vi <a href="/eget-design/">specialdesignede bordkort</a>.</p>
            <h2 style="margin-top:2rem">Kontakt</h2>
            <p>Har du spørgsmål? Kontakt os på:</p>
{CONTACT_ABOUT}
        </div>
...
{NETLIFY_FORM}
    ...
    <div class="lightbox" id="lightbox" style="display:none">
        ...
        <img class="lightbox-img" id="lightboxImg" src="" alt="Forstørret produktbillede">
    </div>
    <div id="imgOverlay" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.85);z-index:9999;justify-content:center;align-items:center;cursor:pointer;" onclick="this.style.display='none'"><img id="imgOverlayImg" src="" alt="Produktbillede i fuld størrelse" style="max-width:90vw;max-height:90vh;object-fit:contain;"></div>
</body>
</html>
"""
...
def main():
    ...
    bordkort_omos = page_shell(
        ...
        description="Læs om Bordkort.dk og vores personlige bordkort i træ. Vi laver bordkort til konfirmation og fest og holder til i Dragør.",
        h1="Om os",
    ...
    navne_faq = [
        ("Hvad koster navnebordkort?", "Fra 10 kr. stykket i birkefiner. Farvede og 3D-printede modeller koster 13–15 kr. Prisen står ved hver model."),
        ("Kan jeg få alle gæsters navne på?", "Ja. Skriv navnene i feltet – ét navn pr. linje – så graverer vi hvert bordkort."),
        ("Hvilket design passer til bryllup?", "Cute og Milk i birkefiner eller valnød er de klassiske valg til bryllup. Farvede modeller bruges oftere til fest og fødselsdag."),
    ]
    bordkort_navne = page_shell(
        slug="navne",
        title="Bordkort med navn i træ | Personlige navnebordkort",
        description="Personlige bordkort med navn i træ til konfirmation og fest. Vælg mellem forskellige designs og træsorter og få gæstens navn skåret i bordkortet.",
        ...
        intro_h2="Personlige bordkort med navn",
        intro=[
            "Vores bordkort med navn bliver lavet personligt til hver gæst og passer perfekt til konfirmation, fødselsdag og andre festlige lejligheder. Vælg mellem forskellige designs og træsorter, og få skåret gæstens navn direkte i bordkortet.",
        ],
    ...
    speciale_faq = [
        ("Hvad koster specielle bordkort?", "De fleste motiver koster 12 kr. stykket. Enkelte koster 10 eller 13 kr. Prisen står ved modellen."),
        ("Kan motivet bruges til konfirmation?", "Ja. Fodbold, gaming og heste er blandt de mest valgte til konfirmation."),
        ("Kan I lave et motiv, der ikke er på listen?", "Ja. Beskriv ønsket på siden eget design, så laver vi et forslag."),
    ]
    bordkort_speciale = page_shell(
        slug="speciale",
        title="Specielle bordkort i træ | Bordkort med motiver",
        description="Find specielle bordkort i træ med forskellige motiver. Personlige bordkort til konfirmation, fest og andre lejligheder.",
    ...
    bryllup_faq = [
        ("Hvilke bordkort passer til bryllup?", "Klassiske navnebordkort i birkefiner eller valnød. Cute og Milk er de mest valgte."),
        ("Hvad koster bordkort til bryllup?", "Fra 10 kr. stykket. I betaler pr. navn. Forsendelse er 55 kr., hvis I ikke afhenter."),
        ("Hvor lang tid tager det?", "Bordkortene laves på bestilling. Skriv datoen i beskeden, så vender vi tilbage med leveringstid."),
    ]
    bordkort_bryllup = page_shell(
        ...
        faq=bryllup_faq,
        site_name="Bordkort.dk",
        nav=lambda slug: nav_html_bordkort("bryllup", prefix="../"),
        footer=BORDKORT_FOOTER,
        favicon="/favicon-bordkort.ico?v=3",
        og_image=BORDKORT_OG_IMAGE,
        og_image_alt=BORDKORT_OG_ALT,
    ...
    write_page("bordkort-site/bryllup/index.html", bordkort_bryllup)

    konfirmation_faq = [
        ("Hvilke bordkort er populære til konfirmation?", "Fodbold, controller og headset, heste og klassiske navnebordkort. Det afhænger af konfirmandens interesser."),
        ("Kan der stå både fornavn og efternavn?", "Ja. Skriv præcis den tekst, der skal på hvert kort."),
        ("Kan I lave et særligt motiv til konfirmanden?", "Ja. Beskriv det på siden eget design, så laver vi et forslag."),
    ]
    bordkort_konfirmation = page_shell(
        ...
        site_name="Bordkort.dk",
        nav=lambda slug: nav_html_bordkort("konfirmation", prefix="../"),
        footer=BORDKORT_FOOTER,
        favicon="/favicon-bordkort.ico?v=3",
        og_image=BORDKORT_OG_IMAGE,
        og_image_alt=BORDKORT_OG_ALT,
    ...
    write_page("bordkort-site/konfirmation/index.html", bordkort_konfirmation)
    ...
    bordkort_eget = page_shell(
        ...
        intro=[
            ...
            "Et specialdesignet bordkort er et bordkort, der ikke findes blandt de færdige modeller. Det kan være en særlig form, et tema eller et personligt ønske, som vi laver efter forespørgsel.",
        ],
        intro_html_extra="""            <h3>Få lavet bordkort med eget motiv</h3>
            <p>Har du en idé til et motiv – en figur, et logo eller noget, der betyder noget for gæsten – kan du beskrive det i formularen. Vi tager udgangspunkt i din idé og vurderer, hvordan den kan blive til et bordkort i træ.</p>
            <h3>Bordkort til tema og fest</h3>
            <p>Specialdesignede bordkort kan tilpasses temaet for festen. Det kan være sport, hobby, en særlig stil eller et motiv, der matcher resten af borddækningen. Du skriver gerne anledning, antal og ønsket udtryk, så vi har et godt grundlag for et forslag.</p>
            <h3>Fra idé til færdigt bordkort</h3>
            <p>Processen er enkel og følger den eksisterende forespørgsel på siden:</p>
            <ol>
                <li>Du sender en idé eller forespørgsel via formularen.</li>
                <li>Vi vurderer designet og mulighederne.</li>
                <li>Du får et forslag og en pris.</li>
                <li>Når du har godkendt, fremstiller vi bordkortene på bestilling.</li>
            </ol>
            <p>Prisen afhænger af motiv, antal og materiale. Leveringstid aftales ud fra din dato. Du kan afhente i Dragør efter aftale eller få bordkortene sendt.</p>
            <p>Har du ikke brug for et specialdesign, kan du også se vores udvalg af <a href="/navne/">personlige bordkort med navn</a>. Der findes også færdige <a href="/speciale/">specielle bordkort</a> med motiver.</p>""",
        intro_before=True,
        products_html="""    <section class="builder" id="eget-design">
        <div class="container">
            <h2 class="no-divider">Send en forespørgsel</h2>
            <p class="section-desc">Beskriv ønsket, så laver vi et forslag og en pris.</p>
            <div class="form-area" style="max-width:520px;margin:0 auto">
                <form class="sign-form">
                    <div class="form-group">
                        <label for="besked_eget_design_bordkort_side">Beskriv dit design / ønsker</label>
                        <textarea id="besked_eget_design_bordkort_side" name="besked_eget_design_bordkort_side" rows="5" placeholder="Beskriv gerne motiv, navne, antal, størrelse og anledning..."></textarea>
                    </div>
                    <div class="form-group">
                        <label for="navn_eget_design_bordkort_side">Navn</label>
                        <input type="text" id="navn_eget_design_bordkort_side" name="navn_eget_design_bordkort_side" placeholder="Dit fulde navn">
                    </div>
                    <div class="form-group">
                        <label for="mail_eget_design_bordkort_side">Mail</label>
                        <input type="email" id="mail_eget_design_bordkort_side" name="mail_eget_design_bordkort_side" placeholder="din@mail.dk">
                    </div>
                    <div class="form-group">
                        <label for="mobil_eget_design_bordkort_side">Mobil nr</label>
                        <input type="tel" id="mobil_eget_design_bordkort_side" name="mobil_eget_design_bordkort_side" placeholder="+45 12 34 56 78">
                    </div>
                    <button type="submit" class="btn-submit">Send forespørgsel</button>
                </form>
            </div>
        ...
        faq=eget_faq,
        site_name="Bordkort.dk",
        nav=lambda slug: nav_html_bordkort("eget-design", prefix="../"),
        footer=BORDKORT_FOOTER,
        favicon="/favicon-bordkort.ico?v=3",
        og_image=BORDKORT_OG_IMAGE,
        og_image_alt=BORDKORT_OG_ALT,
    ...
    write_page("bordkort-site/eget-design/index.html", bordkort_eget)
    ...
    bordkort_urls = [
        ...
        "https://bordkort.dk/bryllup/",
        "https://bordkort.dk/konfirmation/",
        "https://bordkort.dk/eget-design/",
        "https://bordkort.dk/om-os/",
    ]
    bk_sitemap = ['<?xml version="1.0" encoding="UTF-8"?>', '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">']
    ...
    print("wrote bordkort-site/sitemap.xml")
