...
def render_card(product: dict, first: bool = False) -> str:
    ...
    return f"""            <article class="product-card" data-beskrivelse="{esc(product.get('description') or product['title'])}">
...
{paras}
    ...
    if favicon.endswith(".png"):
        icon_links += '\n    <link rel="apple-touch-icon" href="/apple-touch-icon-bordkort.png">'
